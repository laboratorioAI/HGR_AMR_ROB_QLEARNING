function [Numero_Ventanas,EMG,Vector_EMG_Features,Vector_EMG_Tiempos,Vector_EMG_Puntos,Nombre_Usuario,gestureName_,groundTruthIndex_,groundTruth_x] = Code_1(orientation,dataPacketSize,RepTraining,RepTotalTraining)
...
if testControl==true
    ...
    emgDataTested     = OfflineDataExp4S(1,Stride,"on");
